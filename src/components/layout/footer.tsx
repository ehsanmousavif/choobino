...
const Footer = () => {
  return (
    <footer className="w-full flex flex-col font-sans">
      ...
      <div className="flex flex-col gap-20 px-32 py-20 pb-30 relative bg-foreground">
        <span className="absolute inset-0 bg-gradient-to-tr from-secondary-500 via-foreground to-foreground opacity-30 z-10" />
        <span className="absolute inset-0 bg-gradient-to-tl from-secondary-500 via-foreground to-foreground opacity-30 z-10" />

        <div className="flex justify-between gap-5 z-20">
          <div className="flex gap-5 flex-col flex-1/2">
            <span className="text-2xl text-default-700">خبرنامه چوبینو</span>
            <b className="text-3xl text-background flex flex-col">
          ...
          <div className="flex flex-1/2 items-center justify-end max-w-1/2">
            <div className="flex gap-5 items-center text-background h-18 w-full">
        ...
        <div className="h-0.5 w-full z-20 relative opacity-20">
        ...
        <div className="flex justify-between gap-10 xl:gap-15 z-20">
          ...
          <div className="flex gap-5 flex-col w-1/4">
            <b className="text-2xl items-center flex gap-5 text-background w-full justify-between">
              <span>درباره ما</span>
          ...
          <div className="flex gap-5 flex-col w-1/4">
            ...
            <a
              ...
              className="text-default-700 flex flex-col gap-2.5 font-bold text-lg"
            >
          ...
          <div className="flex gap-5 flex-col w-1/4">
            ...
            <span className="text-default-700 flex flex-col gap-2.5 text-lg font-bold">
        ...
        <div className="flex justify-between gap-5 z-20">
          ...
          <div className="flex gap-5 flex-col w-1/4">
            ...
            <div className="text-lg text-background flex flex-col">
              <span>پالیز کمپانی را</span>
              <span>در شبکه های اجتماعی دنبال کنید</span>
            </div>
          </div>
        </div>

        <div className="flex gap-10 justify-between items-center z-20">
          <div className="flex gap-5 items-center text-default-700 text-base">
